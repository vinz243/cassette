      ...
      model.prototype.getPayload = function () {
        ...
        for (var _index in self.fields) {
          ...
          if (field.validator && !field.validator(value)) {
            if (field._required) throw new Error('Field ' + field.name + ' is required but has invalid value');else if (value !== undefined) _storyboard.mainStory.info('db', 'Dropping field ' + field.name + ' with ' + value);
          } else {
