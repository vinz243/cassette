...
var api = exports.api = new _GazelleAPI2.default({
  username: _config2.default.get('pthUsername'),
  password: _config2.default.get('pthPassword')
});
            ...
            switch (_context.prev = _context.next) {
              ...
              case 5:
                ...
                return api.login().then(function () {
                  return api.searchTorrents(data.artist + ' ' + data.name, ctx.request.query.lossless - 0);
                });
