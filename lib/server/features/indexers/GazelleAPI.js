    ...
    value: function call(method, args) {
      ...
      return new Promise(function (resolve, reject) {
        setTimeout(function () {
          ...
          _this._request.get(url, function (err, res, data) {
            if (err) return reject(err);
            var json = Object.assign({}, JSON.parse(data));
            resolve(json);
          });
        }, (0, _utils.nextCallDelay)(_this._calls, _this._config.rateLimitMaxCalls, _this._config.rateLimitTimeFrame));
      });
    }
  }, {
    key: 'searchTorrents',
