...
var GazelleAPI = function () {
  ...
  _createClass(GazelleAPI, [{
    ...
    value: function searchTorrents() {
      ...
      var lossless = arguments[1];

      return this.call('browse', { searchstr: q }).then(function (res) {
        return GazelleAPI.parseTorrents(res, lossless);
      });
    }
  }, {
    key: 'getRawTorrent',
    ...
    key: 'parseTorrents',
    value: function parseTorrents(res, lossless) {
      if (!res || !res.response) {
      ...
      return Promise.resolve((0, _utils.expandArray)(res.response.results, 'torrents', false).map(function (el) {
        return GazelleAPI.toRelease(el, lossless);
      }));
    }
  }, {
    key: 'toRelease',
    value: function toRelease(_ref) {
      ...
      var lossless = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
