...
var scan = exports.scan = function () {
  var _ref11 = _asyncToGenerator(regeneratorRuntime.mark(function _callee(libraryId) {
    ...
    var library, cached, currentEntries, current, diff, mapper;
        ...
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            cached = new _fsTreeDiff2.default({
              entries: (0, _tree.getCachedEntries)(libraryId)
            });
          ...
          case 10:
            return _context.abrupt('return', (0, _tree.writeCachedEntries)(libraryId, currentEntries));
