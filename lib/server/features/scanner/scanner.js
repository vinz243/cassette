...
exports.scan = exports.operationMapperFactory = exports.normalizeArtist = exports.titleCase = undefined;

var _slicedToArray = function () { function sliceIterator(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"]) _i["return"](); } finally { if (_d) throw _e; } } return _arr; } return function (arr, i) { if (Array.isArray(arr)) { return arr; } else if (Symbol.iterator in Object(arr)) { return sliceIterator(arr, i); } else { throw new TypeError("Invalid attempt to destructure non-iterable instance"); } }; }();

exports.getMediastic = getMediastic;
...
var _artworkAgent = require('../artworks/artwork-agent');
...
var fetchArtwork = (0, _artworkAgent.fetchEntityArtworkFactory)(_fsPromise2.default, _path2.default, _touch2.default, _requestPromiseNative2.default, _qs2.default, _md2.default);

function getMediastic() {
  var mediastic = new _mediastic2.default();
  var artworkAgent = (0, _artworkAgent.agentFactory)(fetchArtwork);
  ...
  mediastic.use(function (metadata, next) {
    ...
    try {
      ...
      _storyboard.mainStory.error('scanner', 'Uncaught exception', { attach: err });
    }
  });
