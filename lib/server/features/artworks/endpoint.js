...
var dataDir = _path2.default.join(_config2.default.get('configPath'), '/cache/');
  ...
  '/v1/albums/:id/art': {
    get: function () {
      var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(ctx) {
        var _ctx$request$query$si, size, album, artist, hash, cachePath, params, url, time, json, data, availableSizes, target, imageUrl, buffer;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 3;
                return _models.Artist.findById(ctx.params.id);
